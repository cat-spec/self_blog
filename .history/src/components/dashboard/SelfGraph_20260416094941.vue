...
const skillsData = {
        ...
        nodes: [
            ...
            {name:"uniapp", mastery: "medium" },
            {name:"微信小程序",mastery: "medium" },
            { name: "Webpack", mastery: "low" },
            { name: "Vite", mastery: "low" },
        ...
        links: [
            ...
            {source:"uniapp", target:"Vue" },
            {source:"微信小程序", target:"Vue" },
