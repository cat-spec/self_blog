      ...
      <div class="w-[180px] shrink-0">
        ...
        <div class="mt-5">
          ...
          <div class="flex items-center gap-2 text-xs opacity-80">
            <span class="inline-flex w-3 h-3 rounded-[2px]" style="background:#0e4429; opacity:0.55" />
            <span>低</span>
            <span class="inline-flex w-3 h-3 rounded-[2px]" style="background:#1f7a3b; opacity:0.7" />
            <span>中</span>
            <span class="inline-flex w-3 h-3 rounded-[2px]" style="background:#39d353; opacity:0.95" />
            <span>高</span>
          </div>
        </div>
      </div>
