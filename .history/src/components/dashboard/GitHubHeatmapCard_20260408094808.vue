...
var myChart = echarts.init(mainChart.value);
...
function levelToColor(level) {
  ...
  if (level === 1) return { backgroundColor: '#0e4429', opacity: 0.55 }
  if (level === 2) return { backgroundColor: '#1f7a3b', opacity: 0.7 }
  return { backgroundColor: '#39d353', opacity: 0.95 }
}
